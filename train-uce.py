...
if __name__ == '__main__':
    ...
    concepts, preserve_concepts = get_prompt(concepts[0])

    concepts = [con.strip() for con in concepts.split(',')]
    preserve_concepts = [con.strip() for con in preserve_concepts.split(',')]
        
    print(concepts)
    print(preserve_concepts)
    ...
    os.makedirs(f'models/uce-erased-{print_text}')

    torch.save(ldm_stable.unet.state_dict(), f'models/uce-erased-{print_text}/uce-erased-{print_text}.pt')
